...
public class BangladeshAffAdapter extends RecyclerView.Adapter<BangladeshAffAdapter.MyViewHolder> {

    private Context context;
    private List<BangladeshAffModel> list;

    public BangladeshAffAdapter(Context context, List<BangladeshAffModel> list) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        BangladeshAffModel model = list.get(position);
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            dropdown.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    BangladeshAffModel mcqModel = list.get(getAdapterPosition());
