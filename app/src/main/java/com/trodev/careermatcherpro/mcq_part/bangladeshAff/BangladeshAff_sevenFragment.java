...
public class BangladeshAff_sevenFragment extends Fragment {
    ...
    public BangladeshAff_sevenFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bangladeshaff_seven, container, false);
    ...
    public class GetData extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                // database info
                JSONArray jsonArray = jsonObject.getJSONArray("bangladeshaff_seven");
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    BangladeshAffModel modelClass = new BangladeshAffModel();
    ...
    private void PutDataIntoRecyclerview(List<BangladeshAffModel> list) {

        progressBar.setVisibility(View.INVISIBLE);
        BangladeshAffAdapter customAdapter = new BangladeshAffAdapter(getContext(), list);
