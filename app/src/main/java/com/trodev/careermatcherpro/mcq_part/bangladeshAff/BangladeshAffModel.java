...
public class BangladeshAffModel {

    String mcq_no, grp_ques, first, second, third, fourth, ans;
    private boolean expandable;

    public BangladeshAffModel() {
    }

    public BangladeshAffModel(String mcq_no, String grp_ques, String first, String second, String third, String fourth, String ans) {
        this.mcq_no = mcq_no;
