...
public class EthicsAdapter extends RecyclerView.Adapter<EthicsAdapter.MyViewHolder> {

    private Context context;
    private List<EthicsModel> list;

    public EthicsAdapter(Context context, List<EthicsModel> list) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        EthicsModel model = list.get(position);
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            dropdown.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    EthicsModel mcqModel = list.get(getAdapterPosition());
