...
public class ComputerAdapter extends RecyclerView.Adapter<ComputerAdapter.MyViewHolder> {
    ...
    private List<ComputerModel> list;

    public ComputerAdapter(Context context, List<ComputerModel> list) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        ComputerModel model = list.get(position);
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            dropdown.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ComputerModel mcqModel = list.get(getAdapterPosition());
