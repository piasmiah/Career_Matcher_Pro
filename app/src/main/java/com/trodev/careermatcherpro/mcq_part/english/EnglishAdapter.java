...
public class EnglishAdapter extends RecyclerView.Adapter<EnglishAdapter.MyViewHolder> {
    ...
    private List<EnglishModel> list;

    public EnglishAdapter(Context context, List<EnglishModel> list) {
    ...
    public EnglishAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.english_mcq_template, parent, false);

        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull EnglishAdapter.MyViewHolder holder, int position) {

        EnglishModel model = list.get(position);
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            dropdown.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    EnglishModel mcqModel = list.get(getAdapterPosition());
