...
public class MentalAdapter extends RecyclerView.Adapter<MentalAdapter.MyViewHolder> {
    ...
    private List<MentalModel> list;

    public MentalAdapter(Context context, List<MentalModel> list) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        MentalModel model = list.get(position);
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            dropdown.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    MentalModel mcqModel = list.get(getAdapterPosition());
