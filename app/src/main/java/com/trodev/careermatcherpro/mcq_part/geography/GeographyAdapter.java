...
public class GeographyAdapter extends RecyclerView.Adapter<GeographyAdapter.MyViewHolder> {

    private Context context;
    private List<GeographyModel> list;

    public GeographyAdapter(Context context, List<GeographyModel> list) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        GeographyModel model = list.get(position);
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            dropdown.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    GeographyModel mcqModel = list.get(getAdapterPosition());
