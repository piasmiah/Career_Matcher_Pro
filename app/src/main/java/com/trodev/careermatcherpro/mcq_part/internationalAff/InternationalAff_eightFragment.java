...
public class InternationalAff_eightFragment extends Fragment {

    private static final String json_url = "https://zobayer-dev-e12aa.web.app/internationalaff_mcq.json";
    RecyclerView recyclerView;
    List<InternationalAffModel> list;
    ProgressBar progressBar;

    public InternationalAff_eightFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_internationalaff_eight, container, false);
    ...
    public class GetData extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                // database info
                JSONArray jsonArray = jsonObject.getJSONArray("internationalaff_eight");
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    InternationalAffModel modelClass = new InternationalAffModel();
    ...
    private void PutDataIntoRecyclerview(List<InternationalAffModel> list) {

        progressBar.setVisibility(View.INVISIBLE);
        InternationalAffAdapter customAdapter = new InternationalAffAdapter(getContext(), list);
