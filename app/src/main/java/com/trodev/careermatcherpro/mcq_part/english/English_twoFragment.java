...
public class English_twoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_english_two, container, false);
    ...
    private void loadData() {
        ...
        English_twoFragment.GetData getData = new English_twoFragment.GetData();
        getData.execute();
    ...
    public class GetData extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                // database info
                JSONArray jsonArray = jsonObject.getJSONArray("english_second");
