...
public class Geography_threeFragment extends Fragment {

    private static final String json_url = "https://zobayer-dev-e12aa.web.app/geography_mcq.json";
    RecyclerView recyclerView;
    List<GeographyModel> list;
    ProgressBar progressBar;

    public Geography_threeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_geography_three, container, false);
    ...
    public class GetData extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                // database info
                JSONArray jsonArray = jsonObject.getJSONArray("geography_three");
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    GeographyModel modelClass = new GeographyModel();
    ...
    private void PutDataIntoRecyclerview(List<GeographyModel> list) {

        progressBar.setVisibility(View.INVISIBLE);
        GeographyAdapter customAdapter = new GeographyAdapter(getContext(), list);
