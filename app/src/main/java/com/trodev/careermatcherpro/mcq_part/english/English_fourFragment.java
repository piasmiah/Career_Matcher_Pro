...
public class English_fourFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_english_four, container, false);
    ...
    private void loadData() {
        ...
        English_fourFragment.GetData getData = new English_fourFragment.GetData();
        getData.execute();
    ...
    public class GetData extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                // database info
                JSONArray jsonArray = jsonObject.getJSONArray("english_four");
