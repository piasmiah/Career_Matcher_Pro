...
public class MathAdapter extends RecyclerView.Adapter<MathAdapter.MyViewHolder> {

    private Context context;
    private List<MathModel> list;

    public MathAdapter(Context context, List<MathModel> list) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        MathModel model = list.get(position);
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            dropdown.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    MathModel mcqModel = list.get(getAdapterPosition());
