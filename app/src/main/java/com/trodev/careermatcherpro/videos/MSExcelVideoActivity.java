...
public class MSExcelVideoActivity extends AppCompatActivity {
    ...
    private void illustrator() {
        ...
        dbRef = reference.child("এমএস_এক্সেল");
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    recyclerView.setLayoutManager(new LinearLayoutManager(MSExcelVideoActivity.this));
                    adapter = new TubeAdapter(list1, MSExcelVideoActivity.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(MSExcelVideoActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
