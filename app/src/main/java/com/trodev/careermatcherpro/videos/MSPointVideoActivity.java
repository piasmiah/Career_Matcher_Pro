...
public class MSPointVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mspoint_video);
    ...
    private void illustrator() {
        ...
        dbRef = reference.child("এমএস_পয়েন্ট");
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    recyclerView.setLayoutManager(new LinearLayoutManager(MSPointVideoActivity.this));
                    adapter = new TubeAdapter(list1, MSPointVideoActivity.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(MSPointVideoActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
