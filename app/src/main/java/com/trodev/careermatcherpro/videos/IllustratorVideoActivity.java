...
public class IllustratorVideoActivity extends AppCompatActivity {
    ...
    private void illustrator() {
        ...
        dbRef = reference.child("ইলাস্ট্রেটর");
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    recyclerView.setLayoutManager(new LinearLayoutManager(IllustratorVideoActivity.this));
                    adapter = new TubeAdapter(list1,IllustratorVideoActivity.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(IllustratorVideoActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
