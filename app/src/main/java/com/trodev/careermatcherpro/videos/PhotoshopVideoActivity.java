...
public class PhotoshopVideoActivity extends AppCompatActivity {
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    recyclerView.setLayoutManager(new LinearLayoutManager(PhotoshopVideoActivity.this));
                    adapter = new TubeAdapter(list1, PhotoshopVideoActivity.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(PhotoshopVideoActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
