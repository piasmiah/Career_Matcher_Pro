...
public class MathActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference_math = FirebaseDatabase.getInstance().getReference("premium").child("pdf_math");
        ...
        reference_math.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        /*database synced*/
        reference_math.keepSynced(true);
